    ...
    loadSettings() {
        ...
        if (this.enabled && this.configurations.get("active.gutter")) {
            this.gutterOpenDecor = vscode.window.createTextEditorDecorationType({
                light: {
                    gutterIconPath: path.join(__dirname, "..", "gutters", "open-light.svg"),
                },
                dark: {
                    gutterIconPath: path.join(__dirname, "..", "gutters", "open-dark.svg"),
                },
                gutterIconSize: "contain"
            });
            this.gutterCloseDecor = vscode.window.createTextEditorDecorationType({
                light: {
                    gutterIconPath: path.join(__dirname, "..", "gutters", "close-light.svg"),
                },
                dark: {
                    gutterIconPath: path.join(__dirname, "..", "gutters", "close-dark.svg"),
                },
                gutterIconSize: "contain"
            });
        }
